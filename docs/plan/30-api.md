...
4. Missing candidate lookups return `404 copy_candidate_not_found` with deterministic selection tuple details (`candidateId`, `requestedSlotId`, `requestedLocale`, `slotId`, `locale`).
